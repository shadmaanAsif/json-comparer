...
export function ComparisonResults({
  ...
  return (
    <section
      ...
      className={`results${expanded ? " is-expanded" : ""}`}
      aria-labelledby="results-heading"
    >
      {/* The single grid item collapsing/expanding the whole card (see .results in
          comparer.css) — inert while collapsed so a keyboard/AT user can't tab or land into
          content that's visually clipped away. Everything below is unchanged; this is purely
          a wrapper for the collapse animation. */}
                ...
                <tbody>
                  {structureFindings.map((finding) => (
                    ...
                    >
                      ...
                      <td>
                        <span className="kind-pill type-changed">
                          {structureLabel(finding.kind)}
                        </span>
                      </td>
